...
The main effect and pattern of protocol differences was replicated with CNR data taken from the target laterality (left or right) (F()), the spatial cue probability (p=.8 or p=.5) or lateralised target with high cue probability contrasts
