...
Understanding the neurophysiology that underpins the brain's ability to filter and extract goal-relevant information from the visual world has been a priority in neuroscience for multiple decades [Duncan, 1995, Buschman, 2015]. At the cortical level, visual information processing has been relatively well mapped out; many observations have demonstrated the correspondence of neural activity in frontal, parietal and visual cortices to the biasing of the visual system towards the specific the specific spaces or features that have been indicated as goal-relevant, i.e. visual selection [add some review papers here]. However, the putative contribution of less interrogated subcortical structures such as the basal ganglia has only become evident more recently. For example, electrophysiological recordings from macaques indicate that cells in the caudate nucleus (CN) respond to the joint location and identity of objects [Hikosaka1], and contribute to the circuitry that guide eye-movements towards goal-relevant objects [Hikosaka, nature 2020]. Testing theories for how the human basal ganglia contribute to visual selection is challenging, given the relative inaccessibility of basal ganglia activity to non-invasive imaging approaches. 

One potentially fruitful method is the utilisation of high-resolution functional magnetic resonance imaging (fMRI). However, imaging the functional activity of the basal ganglia is challenging. The relatively higher iron content of the nuclei of the basal ganglia [e.g. Drayer 1986] results in shorter $T^{*}_{2}$ relaxation times compared to the cortex [Peters, 2007]. For optimal BOLD-sensitivity, the echo time (TE) of a single echo-planar imaging (EPI) protocol should be equal to the $T^{*}_{2}$ of the tissue of interest [Posse, 1999]. [insert sentence about typical imaging parameters].

This imaging challenge has been well addressed in other studies that have sought to image functional basal ganglia activity during other forms of cognitive challenge. For example, [Militec et al] compared protocols for studying both cortical and subcortical areas at 7 tesla (7T) during performance of a stop-signal task where participants execute or withhold an overt motor response depending on the given visual signal. The contribution of the basal ganglia to overt action has been well-mapped [insert review ref], and therefore imposing a cognitive challenge during overt action selection is a good place to start for determining the potential of 7T imaging for mapping basal ganglia activity during the resolution of such challenges. 

High iron content, therefore fast imaging required. However, Forstmann et al have found over several papers that you can apply sequences to get meaningful activity with go/no-go. Also Puckett et al. However typically for overt tasks.
