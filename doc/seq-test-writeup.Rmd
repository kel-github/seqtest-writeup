...
Tthrsh_me_prot <- emmeans(Tthrshmod, "TR")
Tthrsh_me_cont <- contrast(Tthrsh_me_prot, 'tukey', adjust = 'sidak') 
Tthrsh_me_cont <- Tthrsh_me_cont %>% broom::tidy()
```  

```{r, thrsh_me_cntrst_FU, echo=TRUE, results="hide"}
Tthrsh_me_cont_mu <- emmeans(Tthrsh_mod, "comp")
